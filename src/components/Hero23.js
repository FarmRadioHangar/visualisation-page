...
function Hero22() {
  ...
  const handleClick = () => {
    ...
    setAudioSrc(`${process.env.PUBLIC_URL}/audio23/${response.ID}.wav`);
        ...
        />
                ...
                <Container maxW={"6xl"} zIndex={10} position={"relative"} bg='#4c9f38' borderRadius="5px" >
                  ...
                  <SimpleGrid columns={6} spacing={0} minHeight='90px' py="3">
                    ...
                    <Box borderRight="1px solid #fff"  textAlign="center" >
                        <Text fontSize={"60px"} lineHeight={"70px"} fontWeight={"600"} letterSpacing={1} mb={2}>24</Text>
                        <Trans i18nKey="SUMMARY_P_6">
                    ...
                    <Box borderRight="1px solid #fff"  textAlign="center" >
                        <Text fontSize={"60px"} lineHeight={"70px"} fontWeight={"600"} letterSpacing={1} mb={2}>49,280</Text>
                        <Trans i18nKey="SUMMARY_P_6">
                        <Text fontSize={"25px"} lineHeight={"30px"}>Poll Responses</Text>
                        </Trans>
                    </Box>
                    <Box textAlign="center" >
                        <Text fontSize={"60px"} lineHeight={"70px"} fontWeight={"600"} letterSpacing={1} mb={2}>8,279</Text>
                        <Trans i18nKey="SUMMARY_P_6">
