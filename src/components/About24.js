...
import photo4 from "../img/OAD24Feature4.jpg";
...
import hero from "../img/OAD24Hero2.jpg"
            ...
            <Stack flex={1} justifyContent="center">
              ...
              <Box>
                <Heading mb={7} fontSize={"5xl"} fontFamily="BebasR" textTransform={"uppercase"}>
                  {t("Reaching African women and men about unpaid care")}
                </Heading>
                {/* <Text mb={4}>{t("ABOUT_P_3")}</Text> */}
                <Text fontFamily={"heading"} fontSize={"xl"} fontWeight={300} mb={4}>{t("ABOUT_24_4")}</Text>
                <Text fontFamily={"heading"} fontSize={"xl"} fontWeight={300} mb={4}>{t("ABOUT_24_5")}</Text>
      ...
      <Box>
        <Container maxW={"6xl"} zIndex={10} py={10} mb={10}>
          <Box>
            ...
            <Text fontFamily={"heading"} fontSize={"xl"} fontWeight={300} mb={5}>{t("ABOUT_24_9")}</Text>
            <Text fontFamily={"heading"} fontSize={"xl"} fontWeight={300} mb={10}>{t("ABOUT_24_10")}</Text>
            <Heading size="lg" mb={2} fontFamily="BebasB">
              {t("Farm Radio International")}
            </Heading>
            <Text fontFamily={"heading"} fontSize={"xl"} fontWeight={300} mb={10}>{t("ABOUT_24_11")}</Text>
            <Heading size="lg" fontFamily="BebasB" mb={2}>
              {t("Global Affairs Canada")}
            </Heading>
            <Text fontFamily={"heading"} fontSize={"xl"} fontWeight={300} mb={10}>{t("ABOUT_24_12")}</Text>
