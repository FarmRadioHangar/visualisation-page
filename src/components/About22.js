          ...
          <Stack direction={{ base: "column", lg: "row" }}>
            ...
            <Stack flex={1} justifyContent="center">
              ...
              <Box>
                ...
                <Text fontFamily={"heading"} fontSize={"xl"} fontWeight={300} mb={4}>{t("ABOUT_P_4i")}</Text>
                <Text fontFamily={"heading"} fontSize={"xl"} fontWeight={300} mb={4}>{t("ABOUT_P_5i")}</Text>
      ...
      <Box>
        <Container maxW={"6xl"} zIndex={10} py={10} mb={10}>
          <Box>
            ...
            <Text fontFamily={"heading"} fontSize={"xl"} fontWeight={300} mb={10}>{t("ABOUT_P_10i")}</Text>
            <Heading size="lg" mb={2} fontFamily="BebasB">
              {t("Farm Radio International")}
            </Heading>
            <Text fontFamily={"heading"} fontSize={"xl"} fontWeight={300} mb={10}>{t("ABOUT_P_11i")}</Text>
            <Heading size="lg" fontFamily="BebasB" mb={2}>
              {t("International Fund for Agriculture Development")}
            </Heading>
            <Text fontFamily={"heading"} fontSize={"xl"} fontWeight={300} mb={10}>{t("ABOUT_P_12i")}</Text>
